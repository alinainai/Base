...
public class ImageConfigImpl extends ImageConfig {
    ...
    public static final class Builder {
         ...
         * <p>
         * 因为 BitmapTransformation 是 Glide 独有的类, 所以如果 BitmapTransformation 出现在 {@link com.jess.arms.http.imageloader.glide.ImageConfigImpl} 中
         * 会使 {@link ImageLoader} 难以切换为其他图片加载框架, 在 {@link com.jess.arms.http.imageloader.glide.ImageConfigImpl} 中只能配置基础类型和 Android 包里的类
