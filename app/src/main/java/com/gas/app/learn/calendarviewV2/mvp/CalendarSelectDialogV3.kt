...
class CalendarSelectDialogV3(private val ctx: Context, private val theme: CalendarTheme) : Dialog(ctx, R.style.dialogFullscreen), CalendarListAdapter.OnDayClickListener {
