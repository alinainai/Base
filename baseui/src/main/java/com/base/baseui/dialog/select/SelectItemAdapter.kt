...
import com.lib.commonsdk.kotlin.extension.invisible
import com.lib.commonsdk.kotlin.extension.visible

class SelectItemAdapter(private val mList: List<ISelectItem>?,private val mListener:OnItemClickListener?) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
