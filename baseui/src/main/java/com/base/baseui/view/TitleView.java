...
public class TitleView extends ConstraintLayout {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        titleTextColor = typedArray.getColor(R.styleable.TitleView_titleColor, ContextCompat.getColor(getContext(), R.color.public_black));

        backColor = typedArray.getColor(R.styleable.TitleView_backColor, ContextCompat.getColor(getContext(), R.color.public_white));

        rightText = typedArray.getString(R.styleable.TitleView_rightText);
        rightTextColor = typedArray.getColor(R.styleable.TitleView_rightTextColor, ContextCompat.getColor(getContext(), R.color.public_black));
    ...
    private void initView(AttributeSet attrs) {
        ...
        initAttrs(attrs);
        View view = View.inflate(getContext(), R.layout.public_layout_title, this);
