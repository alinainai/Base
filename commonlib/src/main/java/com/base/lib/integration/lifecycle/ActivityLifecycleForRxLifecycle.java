...
/**
 * ================================================
 * 配合 {@link ActivityIRxLifecycle} 使用,使 {@link Activity} 具有 {@link RxLifecycle} 的特性
 * ================================================
 */
@Singleton
public class ActivityLifecycleForRxLifecycle implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
        if (activity instanceof ActivityIRxLifecycle) {
        ...
        Timber.tag("ActivityLifecycle").e("onActivityCreated");
    }
    ...
    /**
     * 从 {@link com.base.lib.base.BaseActivity} 中获得桥梁对象 {@code BehaviorSubject<ActivityEvent> mLifecycleSubject}
     *
    ...
    private Subject<ActivityEvent> obtainSubject(Activity activity) {
        return ((ActivityIRxLifecycle) activity).provideLifecycleSubject();
    }
}
