 ...
 */
package com.base.lib.base.config;
...
public final class ManifestParser {
    private static final String MODULE_VALUE = "ClientConfigModule";
    ...
    public List<ClientConfigModule> parse() {
        List<ClientConfigModule> modules = new ArrayList<>();
        try {
    ...
    private static ClientConfigModule parseModule(String className) {
        Class<?> clazz;
        try {
