...
import com.base.lib.integration.lifecycle.IRxLifecycle;
...
public class RxLifecycleUtils {
    ...
    public static <T, R> LifecycleTransformer<T> bindUntilEvent(@NonNull final IRxLifecycle<R> lifecycleable,
                                                                final R event) {
    ...
    public static <T> LifecycleTransformer<T> bindToLifecycle(@NonNull IRxLifecycle lifecycleable) {
        Preconditions.checkNotNull(lifecycleable, "lifecycleable == null");
        if (lifecycleable instanceof ActivityIRxLifecycle) {
            return RxLifecycleAndroid.bindActivity(((ActivityIRxLifecycle) lifecycleable).provideLifecycleSubject());
        } else if (lifecycleable instanceof FragmentIRxLifecycle) {
            return RxLifecycleAndroid.bindFragment(((FragmentIRxLifecycle) lifecycleable).provideLifecycleSubject());
        } else {
