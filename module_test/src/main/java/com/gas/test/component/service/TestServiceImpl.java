 ...
 */
package com.gas.test.component.service;
 ...
 * ================================================
 */
@Route(path = RouterHub.TEST_SERVICE_TESTINFOSERVICE, name = "test服务")
public class TestServiceImpl implements TestInfoService {
    private Context mContext;

    @Override
    public TestInfo getInfo() {
        return new TestInfo("测试组件");
    }
