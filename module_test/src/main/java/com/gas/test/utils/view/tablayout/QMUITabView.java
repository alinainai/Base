...
import com.gas.test.utils.view.tablayout.utils.QMUICollapsingTextHelper;
import com.gas.test.utils.view.tablayout.utils.TabUtils;
    ...
    public void setSelectFraction(float fraction) {
        ...
        if (tabIcon != null) {
            tabIcon.setSelectFraction(fraction,
                    TabUtils.computeColor(mTab.getNormalColor(this),
