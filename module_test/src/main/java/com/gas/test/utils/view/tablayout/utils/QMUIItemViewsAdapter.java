...
import com.gas.test.utils.view.tablayout.QMUITab;
import com.gas.test.utils.view.tablayout.QMUITabSegment2;
 ...
 * 复用已存在的 {@link View}。
 * QMUI 用于 {@link QMUITabSegment2} 中 {@link QMUITab} 与数据的适配。
 *
 * @author cginechen
 * @date 2016-11-27
 */
