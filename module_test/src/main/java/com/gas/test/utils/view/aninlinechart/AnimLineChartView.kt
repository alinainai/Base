package com.gas.test.utils.view.aninlinechart
...
class AnimLineChartView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0)
    ...
    private fun initAttrs(attrs: AttributeSet) {
        ...
        circleWidth = typedArray.getDimension(R.styleable.AnimLineChartView_circleWidth, circleWidth)
//        bgInnerCircleWidth = typedArray.getDimension(R.styleable.AnimLineChartView_bgInnerCircleWidth, bgInnerCircleWidth)
        typedArray.recycle()
    }
