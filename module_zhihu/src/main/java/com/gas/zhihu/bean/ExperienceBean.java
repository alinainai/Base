...
@Entity(nameInDb = "experiencebean")
public class ExperienceBean {
    ...
    @Generated(hash = 1644599690)
    public ExperienceBean(Long id, String pathName, String mapKey, int voltageLevel,
