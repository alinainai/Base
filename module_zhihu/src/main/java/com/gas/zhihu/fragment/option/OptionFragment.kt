...
import com.gas.zhihu.fragment.option.mvp.OptionPresenter
 ...
 * }
 */
class OptionFragment : BaseFragment<OptionPresenter>(), OptionContract.View {
    companion object {
    ...
    override fun setupFragmentComponent(appComponent: AppComponent) {
        DaggerOptionComponent //如找不到该类,请编译一下项目
                ...
                .optionModule(OptionModule(this))
                .build()
                .inject(this)
    }
